...
public final class LoggerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<build.aspect.examples.LogMessage,
      build.aspect.examples.Empty> getSendLogMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendLogMessage",
      requestType = build.aspect.examples.LogMessage.class,
      responseType = build.aspect.examples.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<build.aspect.examples.LogMessage,
      build.aspect.examples.Empty> getSendLogMessageMethod() {
    io.grpc.MethodDescriptor<build.aspect.examples.LogMessage, build.aspect.examples.Empty> getSendLogMessageMethod;
      ...
      synchronized (LoggerGrpc.class) {
        if ((getSendLogMessageMethod = LoggerGrpc.getSendLogMessageMethod) == null) {
          LoggerGrpc.getSendLogMessageMethod = getSendLogMessageMethod =
              io.grpc.MethodDescriptor.<build.aspect.examples.LogMessage, build.aspect.examples.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendLogMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  build.aspect.examples.LogMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  build.aspect.examples.Empty.getDefaultInstance()))
  ...
  public static abstract class LoggerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendLogMessage(build.aspect.examples.LogMessage request,
        io.grpc.stub.StreamObserver<build.aspect.examples.Empty> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                build.aspect.examples.LogMessage,
                build.aspect.examples.Empty>(
  ...
  public static final class LoggerBlockingStub extends io.grpc.stub.AbstractBlockingStub<LoggerBlockingStub> {
    ...
    /**
     */
    public build.aspect.examples.Empty sendLogMessage(build.aspect.examples.LogMessage request) {
  ...
  public static final class LoggerFutureStub extends io.grpc.stub.AbstractFutureStub<LoggerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<build.aspect.examples.Empty> sendLogMessage(
        build.aspect.examples.LogMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_LOG_MESSAGE:
          serviceImpl.sendLogMessage((build.aspect.examples.LogMessage) request,
              (io.grpc.stub.StreamObserver<build.aspect.examples.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoggerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return build.aspect.examples.GreeterProto.getDescriptor();
    }
